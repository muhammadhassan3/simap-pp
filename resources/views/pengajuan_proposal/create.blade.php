                ...
                <form action="{{ route('pengajuan_proposal.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select id="nama_tempat" name="nama_tempat" class="form-control" required>
                            ...
                            <option value="{{ $tp->id_tempat_proyek }}" {{ old('nama_tempat') == $tp->id_tempat_proyek ? 'selected' : '' }}>
                                {{ $tp->nama_tempat }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="harga_proyek" name="harga_proyek" required placeholder="Masukkan harga proyek" oninput="formatCurrency(this)">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="keterangan_proposal" name="keterangan_proposal" placeholder="Tulis..."></textarea>
                    </div>

                    <button type="submit" class="btn btn-primary w-100">Tambah Proposal</button>
                </form>
            </div>
        </div>
    </div>
