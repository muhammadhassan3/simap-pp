                ...
                <form action="{{ route('pengajuan_proposal.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select id="id_tempat_proyek" name="id_tempat_proyek" class="form-control bg-light"
                                required>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control bg-light" id="harga_proyek" name="harga_proyek"
