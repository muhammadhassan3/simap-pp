        ...
        <div class="container d-flex justify-content-center align-items-center vh-100">
            <div class="w-50">
                ...
                <div class="card p-4">
                    ...
                    <form action="{{ route('pengajuan_proposal.update', $proposal->id_pengajuan_proposal) }}"
                            ...
                            <select id="nama_tempat" name="nama_tempat" class="form-control" required>
                                ...
                                @foreach ($tempatProyek as $tp)
                                    <option value="{{ $tp->id_tempat_proyek }}"
                                        {{ old('nama_tempat', $proposal->nama_tempat) == $tp->id_tempat_proyek ? 'selected' : '' }}>
                                        {{ $tp->nama_tempat }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="harga_proyek" name="harga_proyek"
                                    required placeholder="Masukkan harga proyek"
                                    value="{{ old('harga_proyek', number_format($proposal->harga_proyek, 0, ',', '.')) }}"
