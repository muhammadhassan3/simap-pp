                ...
                <form action="{{ route('tim-proyek.update', $tim->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="peran" class="form-control">
                            ...
                            <option value="supervisor" {{ $tim->peran == 'supervisor' ? 'selected' : '' }}>Supervisor
                            </option>
                            <option value="pengawas" {{ $tim->peran == 'pengawas' ? 'selected' : '' }}>Pengawas
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="keahlian" class="form-control"
                            value="{{ old('keahlian', $tim->keahlian ?? '') }}">
                    </div>

                    <!-- Tombol Simpan & Batal -->
                    <div class="d-flex justify-content-end gap-2">
                        <a href="{{ route('tim-proyek.detail', $tim->id_project_disetujui) }}"
