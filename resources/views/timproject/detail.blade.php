    ...
    <div class="card mb-4">
        <div class="card-header pb-0" style="background: white">
            ...
            <div class="d-flex justify-content-between mb-3">
                <a href="{{ route('tim-proyek.create', ['id_project_disetujui' => $id]) }}" class="btn btn-primary">+
                    Tambah Tim Proyek</a>
                <!-- Form Pencarian -->
                <form action="{{ route('tim-proyek.detail', ['id' => $id]) }}" method="GET">
                    <div class="input-group">
                        <input type="text" name="search" value="{{ request('search') }}" class="form-control"
                            placeholder="Cari nama pekerja..." style="height: 40px;">
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle border rounded shadow-sm">
                    ...
                    <tbody>
                        @forelse($tim as $t)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('tim-proyek.edit', $t->id) }}"
                                        class="btn btn-warning btn-md rounded-2 px-3 py-2">
                                        <i class="fas fa-pencil-alt"></i>
                                    </a>
                                    <form action="{{ route('tim-proyek.destroy', $t->id) }}" method="POST"
                                        class="d-inline"
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="text-center text-muted">Tidak ada hasil ditemukan.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
