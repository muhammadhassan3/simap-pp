                    ...
                    <td class="action-buttons">
                        <a href="/sewa_alat/{{ $alat->id }}/edit" class="edit-button">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                <path d="M14.1 4.22l5.66 5.66-9.19 9.19-5.66-5.66 9.19-9.19M15.5 3c-.4 0-.8.15-1.06.44L3.44 14.5a1.5 1.5 0 000 2.12l4.95 4.95c.29.29.67.44 1.06.44s.78-.15 1.06-.44L20.56 9.5a1.5 1.5 0 000-2.12l-4.95-4.95A1.5 1.5 0 0015.5 3z"></path>
                            </svg>
                        </a>
