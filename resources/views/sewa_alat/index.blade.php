    ...
    <div class="col-12">
        <div class="card mb-4">
            <div class="card-header pb-0" style="background: white">
                <div style="font-size: 16px; margin-bottom: 18px" class="fw-bold">Data Sewa Alat Berat</div>
                <div class="top-bar">
                        ...
                        <tbody>
                            @foreach ($sewaAlat as $alat)
                                <tr>
                                    ...
                                    <td>{{ $alat->qty }}</td>
                                    <td>{{ $alat->tempatProyek ? $alat->tempatProyek->nama_tempat : 'Tidak Diketahui' }}
                                    </td>
                                    <td>{{ $alat->detail }}</td>
                                    <td class="action-buttons">
                                        <a href="/sewa_alat/{{ $alat->id }}/edit" class="edit-button text-black">
                                            <i class="fas fa-pencil-alt"></i>
                                        </a>
                                        <form action="/sewa_alat/{{ $alat->id }}" method="POST"
