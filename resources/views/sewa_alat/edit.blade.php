            ...
            <div class="card-header pb-0" style="background: white">
                ...
                <form action="{{ route('sewa_alat.update', $sewa_alat->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="nama_alat" value="{{ $sewa_alat->nama_alat }}"
                            required>
                    </div>
                    <div class="mb-3">
                        <label for="harga_sewa" class="form-label">Harga Sewa</label>
                        <input type="number" class="form-control" name="harga_sewa"
                            value="{{ $sewa_alat->harga_sewa }}" required>
                    </div>
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="customer_id" required>
                            ...
                            @foreach ($customers as $customer)
                                <option value="{{ $customer->id }}"
                                    {{ $sewa_alat->customer_id == $customer->id ? 'selected' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="durasi" value="{{ $sewa_alat->durasi }}"
                            required>
                    </div>
                    <div class="mb-3">
                        <label for="qty" class="form-label">Qty</label>
                        <input type="number" class="form-control" name="qty" value="{{ $sewa_alat->qty }}"
                            required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        <a href="{{ route('sewa_alat.index', ['id_proyek_disetujui' => $idProyekDisetujui]) }}"
