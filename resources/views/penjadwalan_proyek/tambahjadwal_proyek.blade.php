        ...
        <div class="card-body">
            <div class="d-flex align-items-center mb-3">
                <a href="{{ url()->previous() }}" class="text-dark fw-semibold text-decoration-none d-flex align-items-center gap-2">
                    <i class="bi bi-arrow-left"></i> Tambah Jadwal
                </a>
            </div>
            ...
            <form id="tambah-form" action="/penjadwalan_proyek/store" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control" id="tanggal_mulai_display"
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control" id="tanggal_selesai_display"
