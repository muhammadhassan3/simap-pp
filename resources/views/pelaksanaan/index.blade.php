<x-layout>
    ...
    <div class="card mb-4">
        <div class="card-body">
            <!-- Button Kembali -->
            <div>
                <a href="{{ route('monitoring_proyek.index', ['id_proyek_disetujui' => $penjadwalan->id_proyek_disetujui]) }}"
            ...
            {{-- Note --}}
            <div class="alert d-flex align-items-center text-white gap-2" style="background-color: #007ADE"
                role="alert">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    ...
                                    <td class="text-center">
                                        <a href="{{ $data->foto ? asset('storage/' . $data->foto) : 'https://via.placeholder.com/50' }}"
                                            ...
                                            <img src="{{ $data->foto ? asset('storage/' . $data->foto) : 'https://via.placeholder.com/50' }}"
                                                alt="Foto" class="rounded img-thumbnail" width="50"
                                                height="50">
