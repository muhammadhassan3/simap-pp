    ...
    @enderror
        ...
        <div class="mb-3">
            ...
            <select name="jenis_pembayaran" class="form-control" required>
                ...
                <option value="LC" {{ old('jenis_pembayaran') == 'LC' ? 'selected' : '' }}>Letter of Credit (LC)</option>
            </select>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
    <input type="number" name="qty[{{ $produk->id }}]" min="0" class="form-control"
        value="{{ old('qty.' . $produk->id) }}" placeholder="">
</td>

                        <td>
                            <select name="unit[{{ $produk->id }}]" class="form-control">
                                <option value="" >Pilih Satuan</option>
                                <option value="kg" {{ old('unit.' . $produk->id) == 'kg' ? 'selected' : '' }}>kg</option>
                                <option value="ton" {{ old('unit.' . $produk->id) == 'ton' ? 'selected' : '' }}>ton</option>
                            </select>
                        </td>
