...
<div class="container">
    ...
    <form action="{{ route('penjualan.update', $penjualan->id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <select name="id_customer" class="form-control" required>
                ...
                @foreach ($customers as $customer)
                    <option value="{{ $customer->id }}" {{ $penjualan->id_customer == $customer->id ? 'selected' : '' }}>
        ...
        <div class="mb-3">
          ...
          <input  type="date" name="tanggal_penjualan" class="form-control" value="{{ old('tanggal_penjualan', $penjualan->tanggal_penjualan) }}" 
    required>
    ...
    <select name="jenis_pembayaran" class="form-control" required>
        ...
        <option value="LC" {{ $penjualan->jenis_pembayaran == 'LC' ? 'selected' : '' }}>Letter of Credit (LC)</option>
    </select>
</div>
                ...
                <tbody>
                    ...
                    @foreach ($produk as $item)
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="number" name="qty[{{ $item->id }}]" min="0" class="form-control"
                                    value="{{ $qty }}">
                            </td>
                            <td>
