<x-layout>
    ...
    <div class="card shadow mt-4">
        ...
        <div class="header-bg d-flex gap-2">
            <a href="{{ route('pembelian.tampil') }}" class="text-dark fw-semibold text-decoration-none d-flex align-items-center gap-2">
                <i class="fa-solid fa-arrow-left"></i>Pembelian
            </a>
        </div>
        <div class="card-body pt-0">
            ...
            <div class="detail-row">
                ...
                <div class="detail-value">
                    {{ $pembelian->proyekDisetujui->pengajuanProposal->nama_proyek ?? 'Tidak Ditemukan' }}</div>
            </div>
            <div class="detail-row">
