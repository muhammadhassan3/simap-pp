<x-layout>
    ...
    <div class="card mb-4">
        <div class="card-header pb-0" style="background: white">
            <h2>Tempat Proyek</h2>
            <div class="d-flex justify-content-between align-items-start w-100 flex-wrap gap-3" style="margin-top: 20px;">
                <!-- Tombol Aksi -->
                <div class="d-flex flex-row gap-2">
                    <button class="btn" style="background: #007ADE; color: white; font-size: 14px; border-radius: 8px;"
