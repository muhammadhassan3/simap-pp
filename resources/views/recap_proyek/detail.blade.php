        ...
        <div class="card p-4">
            ...
            <div class="table-responsive">
                ...
                <table class="table table-striped align-items-center mb-0">
                    <thead>
                        <tr>
                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Nama Proyek
                            </th>
                ...
                <table class="table table-striped align-items-center mb-0">
                    ...
                    <tbody id="projectTable2">
                        ...
                        @foreach ($penyewaan as $item)
                            <tr>
                                <td>{{ $item->proyek_disetujui->pengajuan_proposal->nama_proyek ?? 'Tidak Ada Nama Proyek' }}
                                </td>
                                <td>{{ $item->proyek_disetujui->pengajuan_proposal->tempat_proyek->alamat ?? 'Tidak Ada Alamat' }}
                                </td>
